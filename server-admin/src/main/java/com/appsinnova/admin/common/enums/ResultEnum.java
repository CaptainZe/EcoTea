package com.appsinnova.admin.common.enums;

import com.appsinnova.admin.common.exception.interfaces.ResultInterface;
...
public enum ResultEnum implements ResultInterface {
     ...
     * 文案问题
     */
    LANG_TEXT_KEY_EXIST(601, "文案key已经存在，不允许重复！"),
