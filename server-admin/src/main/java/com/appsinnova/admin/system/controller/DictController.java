...
import com.appsinnova.admin.system.validator.DictValid;
import com.appsinnova.admin.component.actionLog.action.SaveAction;
...
public class DictController {
    ...
    @GetMapping("/copy/{id}")
    @RequiresPermissions("system:dict:edit")
    public String toCopy(@PathVariable("id") Dict dict, Model model) {
        dict.setId(null);
        dict.setName(dict.getName() + "_copy");
        model.addAttribute("dict", dict);
        return "/system/dict/add";
    }
