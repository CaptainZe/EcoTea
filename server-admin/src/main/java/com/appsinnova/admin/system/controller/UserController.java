...
import com.appsinnova.admin.common.exception.ResultException;
...
import com.appsinnova.admin.system.validator.UserValid;
import com.appsinnova.admin.component.actionLog.action.StatusAction;
import com.appsinnova.admin.component.actionLog.action.UserAction;
import com.appsinnova.admin.component.actionLog.annotation.ActionLog;
import com.appsinnova.admin.component.actionLog.annotation.EntityParam;
import com.appsinnova.admin.component.excel.ExcelUtil;
import com.appsinnova.admin.component.shiro.ShiroUtil;
import com.appsinnova.admin.system.repository.UserRepository;
...
public class UserController {
    ...
    public void picture(String p, HttpServletResponse response) throws IOException {
        String defaultPath = "/images/user2.jpg";
