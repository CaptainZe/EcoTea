package com.appsinnova.admin.component.actionLog.annotation;

import com.appsinnova.admin.common.utils.SpringContextUtil;
import com.appsinnova.admin.component.actionLog.action.base.ActionMap;
import com.appsinnova.admin.component.actionLog.action.base.ResetLog;
import com.appsinnova.admin.component.actionLog.action.model.ActionModel;
import com.appsinnova.admin.component.actionLog.action.model.BusinessMethod;
import com.appsinnova.admin.component.actionLog.action.model.BusinessType;
import com.appsinnova.admin.component.shiro.ShiroUtil;
import com.appsinnova.admin.system.service.ActionLogService;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.appsinnova.admin.component.actionLog.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        // 封装日志实例对象
        com.appsinnova.admin.system.domain.ActionLog actionLog = new com.appsinnova.admin.system.domain.ActionLog();
